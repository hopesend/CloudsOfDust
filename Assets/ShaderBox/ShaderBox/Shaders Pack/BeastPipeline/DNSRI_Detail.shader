Shader "ShaderBox/Opaque Specular/Self-Illumin/_High" {
...
Properties 
{
	...
	_Detail ("Detail map (RGB)", 2D) = "white" {}
...
SubShader {
	...
	FallBack "ShaderBox/Opaque Specular/Self-Illumin/__Middle"
}
