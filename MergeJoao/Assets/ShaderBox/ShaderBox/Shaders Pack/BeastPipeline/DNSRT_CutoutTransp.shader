Shader "ShaderBox/Cutout Specular Transparent/__Middle" {
...
LOD 300
	...
	Pass 
	{
		...
		float4 frag(v2f i) : COLOR
		{
			...
			half3 Emission = texCUBE(_ReflectionCube, vReflection).rgb;
...
Fallback "ShaderBox/Cutout Specular Transparent/___Low"
}
