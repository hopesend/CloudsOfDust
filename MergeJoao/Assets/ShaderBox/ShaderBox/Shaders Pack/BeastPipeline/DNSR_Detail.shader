Shader "ShaderBox/Opaque Specular/_High" {
...
SubShader {
	...
	Pass {
		...
		CGPROGRAM
			...
			float4 frag(v2f i) : COLOR
			{
				...
				o.Normal.xy += UnpackNormal(detailNormal).xy;
				...
				result.a = _Color.a * atten * o.Specular;
	...
	FallBack "ShaderBox/Opaque Specular/__Middle"
}
